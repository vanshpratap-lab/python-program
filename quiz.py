...
# POLISHED CODE
quiz = [
        { "question" : "whos the prime minister of india",
          "options": ["1. narendra modi" , "2. amit shah" , "3. yogi adityanath" ],
          "answer" : "1"
        },
        {
           "question" : "who created python",
           "options" : ["1. charles babbage" , "2. Guido van Rossum", "3. David Heinemeier Hansson"],
           "answer" : "2"
        },
        {
            "question" : "which language is called the mother of all langauges",
            "options" : ["1. c", "2. FORTRAN", "3. cobal"],
            "answer" : "1"
        },
        {
            "question" : "in which year was fortran created",
            "options" : ["1. 1986", "2. 1967", "3. 1957"],
            "answer" : "3"
        }
           ]
